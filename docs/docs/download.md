...
!!! warning "Accessible Directories"
	...
	If you want to whitelist additional directories, you can do so with [do so with `flatseal` or `flatpak override`](troubleshooting.md#flatpak-release-will-not-load-the-hard-drive).

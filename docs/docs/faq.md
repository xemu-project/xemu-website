...
Join the Discord server and chat about what you're seeing in #general, as maybe it's a known issue. We can work together to get it recorded and fixed.

#### Q: Are there system requirements?
Yes, see our [system requirements](about.md#system-requirements) documentation.

#### Q: Performance is bad. What can I do about it?
See our troubleshooting documentation for tips to improve performance in [Windows](troubleshooting.md/#windows-performance-considerations) and [Linux](troubleshooting.md/#linux-performance-considerations). Note that xemu is evolving and performance is subject to change.

#### Q: What BIOS do I need to use?
Your MCPX and BIOS dump should be from a 1.0 Xbox. It's suggested that your MCPX dump be 1.0 and that a compatible BIOS image be used (users have reported success with "COMPLEX 4627").
...
This is likely due to missing, mismatched, or corrupt MCPX and BIOS images. See our [required files](required-files.md)  documentation for details.

#### Q: Why am I getting `Please insert an Xbox disc...`? Where's the classic Xbox menu?
Unfortunately we can't legally ship the original Xbox dashboard, so what you're seeing is the placeholder. See our [dashboards](dashboard.md) documentation for more information, including details on how to install the one you want.

#### Q: I loaded an ISO, but I'm still getting `Please insert an Xbox disc...`
Try restarting xemu. If you continue to get the message, your ISO may not be dumped in a compatible way. See our [disc images](disc-images.md) documentation for instructions on how to create a compatible disc image.
...
You've loaded a "redump" style ISO. xemu does not support this format yet. You can however convert a redump style ISO to a compatible ISO. See our [disc images](<https://xemu.app/docs/disc-images/#about-redump-isos>) documentation for details.

#### Q: Does xemu support "redump" style ISOs?
No, not yet. You can however convert a redump style ISO to a compatible ISO. See our [disc images](<https://xemu.app/docs/disc-images/#about-redump-isos>) documentation for details.
...
#### Q: The compatibility list says my game is Playable, so why is it not working (freezes, dirty disc)?
...
No, not directly. xemu emulates the hardware of the system, so you'll need to have a disc image of your game backup. See our [disc images](disc-images.md) documentation for instructions on how to create a compatible disc image.
...
Generally, no. You will need to create a backup of your game disc. Please see our documentation about [creating and using disc images](disc-images.md).
...
Snapshot data is stored on the hard drive image, and is not easily extractable.

#### Q: How do I use my computer's microphone in game?
xemu has preliminary support for [Xbox Live Communicator emulation](xblc.md) to provide voice chat in-game.
...
Many Xbox games also support System Link for LAN-based multiplayer. xemu does support networking, and this is another way to play with others over the Internet. See our documentation about [networking](networking.md) xemu to other instances of xemu, or even to real Xboxes.
...
Yes. See our documentation about [networking](networking.md). See respective project pages for details about getting set up on their network.
